            ...
            <Card className="col-span-2 rounded-3xl border-0 shadow-sm">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    <div className="flex gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-[#bbfc2f]"></span> หน้าร้าน</div>
                    </div>
                </CardHeader>
                <CardContent>
                            ...
                            <AreaChart data={data} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                                <defs>
                                    <linearGradient id="colorOffline" x1="0" y1="0" x2="0" y2="1">
                                        <stop offset="5%" stopColor="#bbfc2f" stopOpacity={0.4} />
                                ...
                                <Area type="monotone" dataKey="offline" stroke="#bbfc2f" strokeWidth={3} fillOpacity={1} fill="url(#colorOffline)" dot={false} activeDot={{ r: 6, fill: '#bbfc2f', stroke: '#fff', strokeWidth: 2 }} />
                ...
                <CardContent className="space-y-6">
                    <div className="w-full relative z-10 space-y-5">
                        ...
                        <div className="w-[60%]">
                            ...
                            <Progress value={45} className="h-1.5 bg-gray-100 w-1/2" indicatorClassName="bg-[#bbfc2f]" />
                        </div>
                    </div>

                    {/* Big Circular Graphic on the right like mockup */}
                    <div className="absolute -right-12 top-16 w-52 h-52 bg-[#bbfc2f] rounded-full flex items-center justify-center p-4 z-0">
